...
args = {
    'training_config': {
        ...
        'steps_before_tau_0': 30  # number of gamesteps with forced exploration (noise applied to action probs)
    },
    'evaluation_config': {
    ...
    'qbit_simulation_config': {
        ...
        'num_timesteps': 0.001 * 1e-3,  # 1e3 number of timesteps for every pulse in pulse list
