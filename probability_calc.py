...
def probability_calculation(
    ...
    return probability_excited


dimensions = config['n_dimensions']
from simulation_speed import Y  # REMIND: import from simspeed!
...
rotation_matrix = Y
fidelity = 0
old_alpha_state_list = [make_alpha_state(dimensions, i).reshape((3,)) for i in range(1, 7, 1)]
old_alpha_state_list = np.array(old_alpha_state_list)
...
def reward_calculation(
    ...
    fidelity = 0.0
    for psi in old_alpha_state_list:
...
if __name__ == '__main__':
    ...
    pulse_str = '11-1-1-1111-1-1-111-1-1-1011-101-1-10-1-1110-11111-101110-1-1111-1-1011-1-1-1111-1-1011-1-100111-110110-11110-1-100-1-1-1-10-1-1-11110-1-111-1-1-1111-1-1-11'
    ...
    print(probability_calculation(pulse_list))
